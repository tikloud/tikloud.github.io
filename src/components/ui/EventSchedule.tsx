export default function EventSchedule() {
  return (
    <section className="bg-white dark:bg-gray-900 antialiased">
      <div className="max-w-7xl px-4 py-8 mx-auto lg:px-6 sm:py-16 lg:py-24">
        ...
        <div className="flow-root max-w-3xl mx-auto mt-8 sm:mt-12 lg:mt-16">
          <div className="-my-4 divide-y divide-gray-200 dark:divide-gray-700">
            ...
            <div className="flex flex-col gap-2 py-4 sm:gap-6 sm:flex-row sm:items-center">
              ...
              <h3 className="text-lg font-semibold text-gray-900 dark:text-white">
                <a href="#" className="hover:underline">Ti Kloud - An Open Framework for Forensic Watermarking</a>
              </h3>
            </div>
