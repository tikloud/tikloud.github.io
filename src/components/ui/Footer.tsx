    ...
    <footer className="p-4 bg-white sm:p-6 dark:bg-gray-800">
      <div className="mx-auto max-w-7xl">
        <div className="md:flex md:justify-between">
          <div className="mb-6 md:mb-0">
            <a href="https://tikloud.github.io" className="flex items-center">
              <img src="https://tikloud.github.io/docs/images/logo.svg" className="mr-3 h-8" alt="FlowBite Logo" />
          ...
          <div className="grid grid-cols-2 gap-8 sm:gap-6 sm:grid-cols-3">
            <div>
              ...
              <ul className="text-gray-600 dark:text-gray-400">
                <li className="mb-4">
                  <a href="https://tikloud.github.io" className="hover:underline">Ti Kloud</a>
                </li>
                <li>
        ...
        <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2022 <a href="https://tikloud.github.io" className="hover:underline">Flowbite™</a>. All Rights Reserved.
          </span>
