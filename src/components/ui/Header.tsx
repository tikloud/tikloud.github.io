...
export default function Header() {
  ...
  return (
    <header className="sticky top-0 z-40 flex-none mx-auto w-full bg-white dark:bg-gray-900 shadow-sm">
      <Banner />
      <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 dark:bg-gray-800">
        <div className="flex flex-wrap justify-between items-center mx-auto max-w-7xl">
          <a href="https://tikloud.github.io" className="flex items-center">
            <Image src="/icon.svg" className="mr-3 h-6 sm:h-9 rounded-xl" alt="Ti Kloud Logo" width={36} height={36} />
          ...
          <div
            className={`${isMobileOpen ? 'flex' : 'hidden'} justify-between items-center w-full lg:flex lg:w-auto lg:order-1`}
            id="mobile-menu-2"
          >
